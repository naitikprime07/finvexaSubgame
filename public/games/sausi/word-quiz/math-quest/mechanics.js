export default class MechanicsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.timerText = this.add.text(
      ...
      30,
      `Time: ${this.timeLeft}`, // â† backticks here!
      {
        fontSize: "45px",
        fontFamily: "Outfit",
        fill: "#FFFFFF",
    ...
    for (let i = 0; i < 3; i++) {
      ...
      // âŒ REMOVE these from inside the loop:
  ...
  showInstructions() {
    ...
    this.descriptionText = this.add
      .text(
        540,
        800,
        "Answer correctly to climb up. Wrong answers push you down. Reach the top before timeâ€™s up! â±ï¸",
        {
          font: "60px Outfit",
          color: "#ffffff",
