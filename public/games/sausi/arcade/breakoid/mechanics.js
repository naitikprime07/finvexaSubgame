export default class MechanicsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.descriptionText = this.add
      .text(
        540,
        800,
        "Swipe to move the paddle and bounce the ball! Break bricks to score â€” each tile gives 10 points. Keep the ball in play and aim for a high score!",
        {
          font: "60px Outfit",
          color: "#ffffff",
  ...
  hitPaddle(ball, paddle) {
    ...
    // Angle range: -75Â° to +75Â° (stronger direction control)
