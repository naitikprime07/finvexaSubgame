class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.once('filecomplete-json-levelConfig', () => {
            ...
            // âœ… ALWAYS load a single PNG player sprite
            ...
            // ðŸ”Š AUDIO: support both local paths and full URLs
            const resolvePath = (u) => {
                if (!u) return null;
    ...
    create() {
        ...
        // âœ… Pull core numbers from JSON so UI + HTP use them
...
function addHTPPopup(scene) {
    ...
    // âœ… Use JSON-driven values for numbers in the HTP text
...
function spawnObstacle(scene) {
    ...
    // âœ… Only aliens now: alien / alien2
